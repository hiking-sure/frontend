...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj6676 = {};return obj6676;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__5028__auto__ = this$;if(and__5028__auto__)
...
{var x__5667__auto__ = (((this$ == null))?null:this$);return (function (){var or__5040__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__5667__auto__)]);if(or__5040__auto__)
{return or__5040__auto__;
} else
{var or__5040__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__5040__auto____$1)
...
return (function (p__6677){var vec__6678 = p__6677;var k = cljs.core.nth.call(null,vec__6678,(0),null);var v = cljs.core.nth.call(null,vec__6678,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
